...
import { coreQcBrand, coreQcContact, coreQcNav, coreQcFooter } from "@/config/coreqc";

const FooterCompact = () => {
  const footerLinks = [
    { label: coreQcNav.homeLabel, href: "/" },
    ...coreQcNav.primaryLinks,
    { label: coreQcNav.aboutLabel, href: "/about" },
    { label: coreQcNav.contactLabel, href: coreQcNav.contactHref },
  ];
    ...
    <footer className="cs_footer cs_style_1 cs_type_2 cs_accent_bg cs_bg_filed" data-src="assets/img/footer-bg-3.svg">
      ...
      <div className="container">
        <div className="cs_footer_top position-relative">
          <ul className="cs_location_list cs_mp_0 cs_footer_compact_contacts">
            <li>
        ...
        <div className="cs_footer_main cs_radius_30">
          <div className="cs_footer_desc">
            ...
            <div className="cs_footer_desc_text">{coreQcBrand.footerDescription}</div>
          </div>
        ...
        <div className="cs_footer_bottom position-relative">
          ...
          <div className="cs_footer_text cs_white_color text-center mt-4 opacity-75">
            {coreQcBrand.copyright}
          </div>
        </div>
      </div>
    </footer>
