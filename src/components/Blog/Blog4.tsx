              ...
              <div className="cs_recent_post_wrapper">
                <div className="cs_recent_post">
                  <Link
                    ...
                    className="cs_recent_post_thumb cs_radius_10"
                    href={detailsHref}
                  >
                  ...
                  <div className="cs_recent_post_right">
                    ...
                    <h3 className="cs_fs_16 cs_bold mb-0">
                      <Link href={detailsHref} aria-label="Reading details post link">There are many vario ns of passages of</Link>
                    </h3>
                  </div>
                </div>
                <div className="cs_recent_post">
        ...
        <div className="col-xl-8 col-lg-7">
          <div className="cs_posts_wrapper">
            ...
            <article key={i} className="cs_post cs_style_1 cs_type_2 cs_radius_16">
              <Link href={detailsHref} aria-label="Reading details post link" className="cs_post_thumbnail cs_radius_10 cs_mb_28 position-relative overflow-hidden">
              ...
              <div className="cs_post_content">
                ...
                <h3 className="cs_post_title cs_fs_30 cs_semibold cs_mb_7"><Link href={detailsHref} aria-label="Reading details post link">{item.title}</Link></h3>
                <p className="cs_post_subtitle cs_heading_font cs_mb_21">{item.content}</p>
                <Link href={detailsHref} aria-label="Reading details post link" className="cs_btn cs_style_1 cs_bg_1 cs_fs_14 cs_semibold cs_heading_font cs_white_color">
                <span>Read More</span>
